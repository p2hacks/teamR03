...
class hide_seek_question_input_3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        // 戻るボタンを押したときの遷移処理
        view.back_input_3_to_question_view_button.setOnClickListener {
            findNavController().navigate(R.id.action_hide_seek_question_input_3_to_hide_seek_question_view)
        }
        return view
    }
